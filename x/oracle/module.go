...
import (
	...
	"github.com/crescent-network/crescent/v5/x/oracle/client/cli"
...
// Deprecated: RegisterRESTRoutes is deprecated. query is delegated to the gRPC
...
func (am AppModule) ExportGenesis(ctx sdk.Context, cdc codec.JSONCodec) json.RawMessage {
	...
	//TODO: add exports
	missCounters := types.MissCounters{} //am.keeper.GetMissCounters(ctx)
	pricePrevotes := types.PricePrevotes{}
	priceVotes := types.PriceVotes{}
	priceOracle := types.OraclePrices{}

	gs := types.NewGenesisState(params, missCounters, pricePrevotes, priceVotes, priceOracle)
