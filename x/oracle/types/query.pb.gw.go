...
var (
	pattern_Query_PriceOracle_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crescent", "oracle", "v1beta1", "price_oracle"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_MissCounter_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crescent", "oracle", "v1beta1", "miss"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Prevotes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crescent", "oracle", "v1beta1", "prevotes"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Votes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crescent", "oracle", "v1beta1", "votes"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crescent", "oracle", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(true)))
)
