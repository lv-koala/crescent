...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	cdc.RegisterConcrete(&MsgPricesPrevote{}, "oracle/MsgPricesPrevote", nil)
	cdc.RegisterConcrete(&MsgPricesVote{}, "oracle/MsgPricesVote", nil)
	cdc.RegisterConcrete(&MsgAddNewTicker{}, "oracle/MsgAddNewTicker", nil)
}
